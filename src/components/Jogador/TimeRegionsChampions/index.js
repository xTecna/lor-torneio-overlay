...
import {TimeRegionsChampions as TimeRegionsChampionsDiv, Time, RegionsChampions, Regions, Region, Champions, Champion} from './style';
...
function renderChampion(champion){
	return <Champion><img src={`http://ddragon.leagueoflegends.com/cdn/10.15.1/img/champion/${champion}.png`}/></Champion>;
};

...
export const RegionsChampions = styled.div`
	width: ${props => props.theme.webcamSize * (props.inline ? (props.time ? 1 : 1.5) : 0.5)};
...
export const Regions = styled.div`
	...
	height: ${props => props.theme.webcamSize*(!props.inline && !props.time ? 0.5 : 0.25)}vh;
	display: flex;
	flex-direction: row;
...
export const Champions = styled.div`
	width: ${props => props.theme.webcamSize * (props.inline ? (props.time ? 1.0 : 1.5) : 0.5)}vh;
	height: ${props => props.theme.webcamSize * (props.inline ? 0.25 : (!props.inline && !props.time ? 0.75 : 0.5))}vh;
